...
<body>
	<div class="top">
		...
		<div class="webnav">
			<ul>
				...
				<li class="licur"><a href="toAricleList?articleType=PL&page.number=1&page.count=15" title="产品展示">产品展示</a></li>
	...
	<div class="index_con">
		...
		<div class="page_right">
			<div class="pagetop">
				<span class="web_navi">当前位置：<a href="#">首页</a> &gt;&gt; 产品展示</span>
				<h2>
					<a href="#">产品展示</a>
				</h2>
			</div>
...
<script>
	...
	function pageGo() {
		...
		if( isNaN(goNumber) ||  goNumber <= 0 || goNumber > allPage ) {
			...
			window.location.href="toAricleList?articleType=PL&page.number="+goNumber+"&page.count="+count+"";			
		}
	}
	...
	function goLastPage() {
		window.location.href="toAricleList?articleType=PL&page.number=1&page.count="+count+"";
	}
	
	function goNextPage() {
		window.location.href="toAricleList?articleType=PL&page.number="+allPage+"&page.count="+count+"";
	}
</script>
</html>