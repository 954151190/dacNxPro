...
<body>
	...
	<div class="index_con">
		...
		<div class="page_right">
			<div class="pagetop">
				<span class="web_navi">当前位置：<a href="#">首页</a> &gt;&gt; 农信要闻
				</span>
				<h2>农信要闻</h2>
			</div>
			<div class="borl_r news_con">
				<h1>${ news.title }</h1>
				<p class="nets_zd">发布时间：${news.create_time } 作者：${news.author_name }</p>
				<div class="news_xq">
					<script id="editor" type="text/plain" style="width:100%;height:500px;">${news.content }</script>
				</div>
			</div>
