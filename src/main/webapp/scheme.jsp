...
<body>
	...
	<div class="index_con">
		...
		<div class="page_right">
			<div class="pagetop">
				<span class="web_navi">当前位置：<a href="#">首页</a> &gt;&gt; 业务介绍
				</span>
				<h2>业务介绍</h2>
			</div>
			<div class="borl_r news_con">
				<h1>${ scheme.title }</h1>
				<p class="nets_zd">发布时间：${scheme.create_time } 作者：${scheme.author_name }</p>
				<div class="news_xq">
					<script id="editor" type="text/plain" style="width:100%;height:500px;">${scheme.content }</script>
				</div>
				<p class="pageback">
					<a href="javascript:history.go(-1);" rel="nofollow">→返回上一页</a>
				</p>
				<ul class="xq_np">
