...
<body>
	<div class="top">
		...
		<div class="webnav">
			<ul>
				...
				<li class="licur"><a href="toAricleList?articleType=BL&page.number=1&page.count=10"
					title="公示公告">公示公告</a></li>
	...
	<div class="index_con">
		...
		<div class="page_right">
			...
			<div class="borl_r">
				<ul class="newslist">
					<s:iterator value="bulletinList" var="ob">
						<li><a href="toAricle?articleType=BL&bulletin.id=${ ob.id }" target="_blank">${ ob.title }</a><span>${ ob.create_time }</span></li>
					</s:iterator>
				</ul>
				<div class="epages">
...
<script>
	...
	function pageGo() {
		...
		if( isNaN(goNumber) ||  goNumber <= 0 || goNumber > allPage ) {
			...
			window.location.href="toAricleList?articleType=BL&page.number="+goNumber+"&page.count="+count+"";			
		}
	}
	...
	function goLastPage() {
		window.location.href="toAricleList?articleType=BL&page.number=1&page.count="+count+"";
	}
	
	function goNextPage() {
		window.location.href="toAricleList?articleType=BL&page.number="+allPage+"&page.count="+count+"";
	}
</script>
</body>
</html>
