...
<body>
	...
	<div class="index_con">
		...
		<div class="page_right">
			<div class="pagetop">
				<span class="web_navi">当前位置：<a href="#">首页</a> &gt;&gt; 业务介绍</span>
				<h2>
					<a href="#">业务介绍</a>
				</h2>
			</div>
			<div class="borl_r singpage">
				<ul class="newslist">
					<s:iterator value="schemeList" var="os">
					<li><a href="toAricle?articleType=SL&scheme.id=${ os.id }" target="_blank">${ os.title }</a><span>${ os.create_time }</span></li>
					</s:iterator>
				</ul>
				<div class="epages">
